...
import com.ac.multitenancydemo.repository.MasterTenantRepository;
...
@EnableJpaRepositories(basePackages = {"com.ac.multitenancydemo.entity", "com.ac.multitenancydemo.repository"},
...
public class MasterDatabaseConfig {
    ...
    public DataSource masterDataSource() {
       return DataSourceBuilder.create()
               .url(masterDbProperties.getUrl())
               .driverClassName(masterDbProperties.getDriverClassName())
               .username(masterDbProperties.getUsername())
               .password(masterDbProperties.getPassword())
               .build();
    }
