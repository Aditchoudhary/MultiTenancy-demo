...
@ComponentScan(basePackages = { "com.ac.multitenancydemo.domain" })
@EnableJpaRepositories(basePackages = {"com.ac.multitenancydemo.domain"},
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan("com.ac.multitenancydemo.domain");
